...
public class Piano {
	...
	private PostoAutoVan[] postiAutoVan = new PostoAutoVan[1000];
	private PostoAutoLusso[] postiAutoLusso = new PostoAutoLusso[1000];
	private PostoAutoNormale[] postiAutoNormale = new PostoAutoNormale[1000];
